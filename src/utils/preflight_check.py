...
def check_dependencies():
    ...
    packages = {"yaml": "pyyaml", "json": "built-in", "re": "built-in", "importlib": "built-in"}
    ...
    try:
        ...
        for name, rel_path in data_paths.items():
            ...
            if full_path.exists():
                ...
                print("   (This is OK if you're testing with manual overrides)")
